...
if (s2.isMelee) {
  ...
  const MAX_TIME = 60;
//firing
  fire_loop(MAX_TIME, hp1, hp2, t1, t2, mag1, mag2, reloading1, reloading2, reloadEnd1, reloadEnd2, dist, p1pos, p2pos);
...
function fire_loop(MAX_TIME, hp1, hp2, t1, t2, mag1, mag2, reloading1, reloading2, reloadEnd1, reloadEnd2, dist, p1pos, p2pos) {
